...
class RecipeProvider(
    ...
    override fun generate(exporter: RecipeExporter) {
        ...
        offerAdamantiteUpgradeRecipe(exporter, Items.NETHERITE_SWORD, RecipeCategory.COMBAT, adamantiteSword)
        ...
        offerTitaniumUpgradeRecipe(exporter, Items.NETHERITE_SWORD, RecipeCategory.COMBAT, titaniumSword)
